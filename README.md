...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Poppins&weight=700&size=30&pause=1000&color=F78BBE&center=true&vCenter=true&random=true&width=600&lines=Full+Stack+Developer+%F0%9F%92%BB;Java+%26+Spring+Boot+%E2%98%95;PHP+%26+Laravel+%F0%9F%94%A7;Testing+%26+Clean+Architecture+%F0%9F%A7%AA)](https://git.io/typing-svg)

[![Portfolio](https://img.shields.io/badge/Portafolio-8B5CF6?style=for-the-badge&logo=googlechrome&logoColor=white)](https://meratim.github.io)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/mariamercedesatim-dev/)
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:mariamercedesatim@gmail.com)
...
### ES
Soy **Desarrolladora Full Stack**, egresada de la Tecnicatura Universitaria en Programación (UTN FRSR).

Trabajo backend con **Java y Spring Boot**, y con **PHP y Laravel** sobre una plataforma en producción. Del lado del cliente, **Vue 3 y React**.

Me interesa el código que se puede mantener: **tests, arquitectura en capas y CI/CD** desde el primer commit. Inglés C1.

</td>
<td width="50%">

### EN
I'm a **Full Stack Developer**, graduated in Programming from UTN FRSR.

I work on the backend with **Java and Spring Boot**, and with **PHP and Laravel** on a production platform. On the client side, **Vue 3 and React**.

I care about code that can be maintained: **tests, layered architecture and CI/CD** from the first commit. English at C1.

</td>
</tr>
</table>

> 🌐 **Portafolio completo con proyectos, logros técnicos y CV descargable → [meratim.github.io](https://meratim.github.io)**
...
| [**CapyMeal**](https://github.com/CapyMeal/CapyMeal) | Diario personal de comidas. Login social OAuth2, sesión por cookie httpOnly cross-origin, export a PDF, PWA instalable y APK de Android. | Vue 3, Vuetify, Laravel 12, PostgreSQL, GitHub Actions, Sentry |
| [**MedConnect**](https://github.com/MerAtim/MediConnect) | Gestión de turnos e historias clínicas con roles. Arquitectura hexagonal, JWT en cookie httpOnly e historia clínica cifrada AES-256-GCM. | Java 17, Spring Boot 3.2, React 18, PostgreSQL, Flyway, Testcontainers, Docker |
...
| [**CapyMarket**](https://github.com/MerAtim/CapyMarket) | E-commerce con carrito, gestión de productos y pagos integrados. | JavaScript, HTML/CSS, Mercado Pago |
| [**CapyTareas**](https://github.com/MerAtim/CapyTareas) | Gestor de tareas con backend y frontend separados, contenedores y despliegue. | Java, JavaScript, Docker, Render |
...
![PHPUnit](https://img.shields.io/badge/PHPUnit-3A6B8C?style=for-the-badge&logo=php&logoColor=white)
